    ...
    if ((a.os.android || a.os.ios) && !b.FastClick) {
        var d = function(a, b) {
            return (
                'LABEL' === b.tagName &&
                b.parentNode &&
                (b = b.parentNode.querySelector('input')), !b || ('radio' !== b.type && 'checkbox' !== b.type) || b.disabled ?
                !1 :
                b
            );
        };
        ...
        l = a.Class.extend({
            ...
            _nearestSnap: function(a) {
                ...
                var b = 0,
                    c = this.pages.length;
                for (
                    a > 0 ? (a = 0) : a < this.maxScrollX && (a = this.maxScrollX); c > b; b++
                ) {
                    var d =
                        'left' === this.direction ?
            ...
            _momentum: function(a, b, c, e, f, g) {
                ...
                return (
                    ...
                    ((h = f ? (f / 2.5) * (j / 8) : 0),
                        (b = Math.abs(a) + h),
                        (i = b / j)), { destination: Math.round(h), duration: i }
                );
            },
            ...
            _reInit: function() {
                for (
                    var a = this.wrapper.querySelectorAll('.' + e), b = 0, c = a.length; c > b; b++
                )
...
(function(a, b) {
    var c = 'mui-slider',
        ...
        l = (a.Slider = a.Scroll.extend({
            ...
            _reInit: function() {
                for (
                    var a = this.wrapper.querySelectorAll('.' + d), b = 0, c = a.length; c > b; b++
                )
                    if (a[b].parentNode === this.wrapper) {
                        this.scroller = a[b];
                        break;
        ...
        a.plusReady(function() {
            if (window.__NWin_Enable__ !== !1) {
                ...
                a.fn.pullRefresh_native = function(d) {
                    ...
                    var f = d;
                    (d = d || {}),
                    'string' == typeof d && (d = a.parseJSON(d)), !d.webviewId &&
                        (d.webviewId =
...
(function(a, b, c, d, e) {
    ...
    a.registerTarget({ name: d, index: 80, handle: l, target: !1 }),
        b.addEventListener('tap', function(b) {
            ...
            if (e) {
                for (
                    var h, l, m, n = 'mui-active', o = '.' + n, p = e.parentNode; p && p !== c; p = p.parentNode
                ) {
                ...
                if (
                    ...
                    if (!q) {
                        ...
                        m.classList.add(n);
                        for (
                            var u = [], v = r.querySelectorAll('.' + i), s = 0; s < v.length; s++
                        )
            ...
            (this.options = b || { actions: 'clear' }), ~this.options.actions.indexOf('slider') ?
                ...
                (~this.options.actions.indexOf('clear') &&
                    ((this.clearActionClass = d + ' ' + e + ' ' + l),
                        (this.clearActionSelector = n)), ~this.options.actions.indexOf('speech') &&
                    ((this.speechActionClass = d + ' ' + f),
                        (this.speechActionSelector = o)), ~this.options.actions.indexOf('search') &&
                    ((this.searchActionClass = j), (this.searchActionSelector = q)), ~this.options.actions.indexOf('password') &&
