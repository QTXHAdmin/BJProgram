            ...
            if (titleConfig) {
                ...
                if (_backImage.base64Data || _backImage.imgSrc) {
                    ...
                    backClick = {
                        ...
                        right: parseInt(_backImage.position.left) +
...
(function ($, window, document, name) {
    ...
    var removeBackdrop = function (popover) {
        ...
        removeBackdropTimer = $.later(function () {
            if (!popover.classList.contains(CLASS_ACTIVE) &&
                backdrop.parentNode &&
        ...
        for (; target && target !== document; target = target.parentNode) {
            if (target.classList) {
                ...
                if (classList.contains(CLASS_TABLE_VIEW_CELL)) {
                    ...
                    if (!cell.parentNode.classList.contains(CLASS_RADIO_VIEW) &&
                        selected &&
                        selected !== cell
                    ) {
...
(function ($, document) {
    ...
    var hideProgressbar = function (container) {
        ...
        if (!classList.contains(CLASS_PROGRESSBAR_IN) ||
